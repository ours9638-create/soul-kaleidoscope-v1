...
App 2.7.0 不得改變計算引擎 2.2.0 的既有公式結果。
...
Prepared Soul Kaleidoscope app v2.7.0 (engine 2.2.0).
```
...
## F. SNGL Number Data、Position Data 與年度解讀
...
- 表格資料來自 Soul Kaleidoscope Visual Model `1.0.0`。
